...
[English](../voice-music.md) · [中文完整流程](../workflow.zh.md)
...
Python 3.10+，PATH 中可用的 FFmpeg/ffprobe；混音需要 `numpy`，Edge 路线另需 `edge-tts`。Qwen 使用 Python 标准 HTTP 库，检查实时官方演示接口，仅提交指定文案和设置。技能不包含凭据、账号、浏览器数据或音乐。
